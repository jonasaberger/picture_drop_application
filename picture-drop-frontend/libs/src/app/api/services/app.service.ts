...
export class AppService extends BaseService {
  ...
  /**
   * Get the status of the Picture-Drop backend.
   *
   *
   *
   ...
   */
  appControllerGetHello$Response(params?: AppControllerGetHello$Params, context?: HttpContext): Observable<StrictHttpResponse<string>> {
